  ...
  <div id="cycles">
        ...
        <v-container>
          ...
          >
            <v-flex xs12>
              ...
              >
                You don't have any active cycles at the moment! Select an older cycle or create a new one.
              </h5>
            </v-flex>
          </v-layout>
          <NewCycle />
          ...
          <v-flex xs12>
            ...
            >
              <h5
                class="subheading"
              >
                This is the cycle's area. Here you can see all your cycles or create a new one. But remember, in order to create a new cycle you must end the current first.
              </h5>
            </v-alert>
          </v-flex>
        </v-layout>
              ...
              <v-card-text>
                ...
                >
                  ...
                  <v-flex xm6>
                    ...
                    <div class="subheading text-balance">
                      $ {{ totalBalance }}
                    </div>
                  </v-flex>
                </v-layout>
              ...
              <v-card-text>
                ...
                >
                  ...
                  <v-flex xm6>
                    ...
                    <div class="subheading text-income">
                      $ {{ incomesTotalValue }}
                    </div>
                  </v-flex>
                </v-layout>
              ...
              <v-card-text>
                ...
                >
                  ...
                  <v-flex xm6>
                    ...
                    <div class="subheading text-expense">
                      $ {{ expensesTotalValue }}
                    </div>
                  </v-flex>
                </v-layout>
    ...
    <div v-else>
      <v-container>
        ...
        >
          <v-flex xs12>
            <h3 class="display-2 mb-1 text-xs-center">
              Looks like you don't have a cycle yet!
            </h3>
          </v-flex>
          <v-flex xs12>
            <h4
            ...
            >
              Feel free to create one and take a better control over your finances.
            </h4>
            <h5
              class="headline grey--text mb-1 text-xs-center"
            >
              To create a new cycle you just have to click the buttom on the bottom right of your screen.
            </h5>
          </v-flex>
        </v-layout>
        <NewCycle />
